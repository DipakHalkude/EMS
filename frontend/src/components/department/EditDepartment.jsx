      ...
      {depLoading ? (
        ...
        <div className="mt-5 min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 p-6">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-3xl font-bold text-white mb-8 text-center bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
              Edit Department
            </h3>
            <form
              onSubmit={handleSubmit}
              className="bg-gradient-to-br from-gray-900/40 to-blue-900/40 backdrop-blur-xl rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 p-8"
            >
              <div className="mb-6">
                <label
                  htmlFor="deptName"
                  className="block text-cyan-300 font-semibold mb-3 text-sm uppercase tracking-wider"
                >
                  Department Name
                </label>
                <input
